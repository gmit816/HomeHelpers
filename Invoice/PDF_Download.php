...
//$pdf->MultiCell(0,10,$row1['answer_detail'],'TB','C');
    ...
    if(!$mail->Send())
    {
        echo "<script>alert('Something Went Wrong during sending Mail. Please Try Again. $mail->ErrorInfo;');document.location='PDF_Download';</script>";
    }
    else{
        echo "<script>alert('The Service is successfully Ended !');document.location='../SP/index.php';</script>";
    }
}