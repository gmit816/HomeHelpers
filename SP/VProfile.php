    ...
    <div id="page-wrapper" style="margin-left: 0px; min-height: 399px;">
        <div class="graphs">
            <div class="xs" style="margin-top: 88px;">
                <h3>View Profile</h3>
                <?php
                    $SPSelect="SELECT * FROM `sprovider_master` WHERE Emp_id='{$_SESSION['User_id']}'";
                ...
                <div class="tab-content col_3" style="margin-top: 24px;">
                    <div class="tab-pane active" id="horizontal-form">
                        <div class="col-sm-10" style="margin-bottom: 12px;">
                            ...
                            <div class="col-sm-10" style="border-bottom: 1px solid;padding-bottom: 8px;">
                                <div class="col-sm-1"> </div>
                                <div class="col-sm-2">Emp Id :</div>
                                <div class="col-sm-2" style="font-weight: 600"><?php echo $SPRow['Emp_id'];?></div>
                                <div class="col-sm-1"> </div>
                                <div class="col-sm-2">HomeHelpers' Points :</div>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="col-sm-2" style="padding-top: 30px;"><?php echo $SPRow['First_name']." ".$SPRow['Last_name'];?></div>
                                <div class="col-sm-1"> </div>
                        ...
                        <div class="col-sm-10" style="margin-top: 12px;">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="col-sm-2"><?php echo $SRow['Service_name'];?></div>
                                <div class="col-sm-1"> </div>
