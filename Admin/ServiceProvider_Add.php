            ...
            <div class="xs">
                ...
                <div class="tab-content" style="margin-top: 80px;">
                    <div class="tab-pane active" id="horizontal-form">
                        <form class="form-horizontal" action="Utility_Service_Provider.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="col-sm-12" style="margin-bottom: 8px;">
                                    <div class="col-sm-2"> </div>
                                    <label for="focusedinput" class="col-sm-2 control-label">Service Provider's Name:</label>
