    ...
    <div class="navbar-default sidebar" role="navigation" style="margin-top: 98px;">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-indent nav_icon"></i>Manage City / Area<span class="fa arrow"></span></a>
                ...
                <li>
                    <a href="ServiceProvider_Manage.php"><i class="fa fa-flask nav_icon"></i>Manage Service Provider</a>
                </li>
                <li>
